...
(function(jq){
	...
	posterTvGrid.prototype = {
		...
		initContent: function(){
			...
			this.parent.find(".contentHolderUnit:nth-child("+this.pageNow+")").css({width:'530px',height:'224px', opacity: 1, left: this.pageNowLeft+'px', zIndex: 3, marginTop: 0});
		...
		turnpage: function(page, dir){
			...
			var run = function(page, dir, t){
				...
				if(dir == 'left'){					
					...
					_this.parent.find(".contentHolderUnit:nth-child("+page+")").animate({opacity: 1, left: _this.pageNowLeft+'px', height: '350px', width: '612px', zIndex: 3, marginTop: '-70px'}, t);
